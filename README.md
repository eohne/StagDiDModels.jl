...
the level you pass, and you do not need to cluster or bootstrap it by hand. 
The usual caveat applies: the errors are only as reliable as the number of clusters, 
so be careful with very few clusters.
